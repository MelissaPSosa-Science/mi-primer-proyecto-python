...
from use_case_saludar import ejecutar
...
def lambda_handler(event, context):
    try:
        ...
        respuesta = ejecutar(nombre,repo)       #Aqui estoy llamando la lógica del negocio, en este caso la función saludar que defini en servicos
